...
async def analyze_single_word_with_llm(
    ...
    prompt_lines.extend([
        ...
        "3. Provide ONLY the improved version of the phrase - no explanations, just the corrected text",
        "4. Explain the issue type and why your improvement is better",
        "",
        ...
        "- Example: if phrase is 'serves powerful tool', suggestion should be 'serves as a powerful tool'",
        "",
        ...
        '          "context": {"type": "string", "description": "Detailed explanation of why this is problematic and how your suggestion improves it"}',
        '        }',
        '      }',
        '    }',
        '  },',
        ...
        '- context: Must include 4 parts: 1) Type of issue (tortured phrase/AI fingerprint/grammar) 2) Specific problem 3) Why it\'s problematic 4) How your suggestion improves it',
        "",
        'EXAMPLE OUTPUT:',
        '- phrase: "serves powerful tool"',
        '- suggestion: "serves as a powerful tool"',
        '- context: "Tortured phrase - missing preposition. This phrase lacks proper grammatical structure and sounds unnatural in academic writing. The suggestion adds the missing \'as\' to create grammatically correct and professional phrasing."',
        "",
        "CRITICAL: Every finding MUST have both a clear problem identification AND a clean improved phrase (no explanatory text).",
