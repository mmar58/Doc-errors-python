...
class SingleWordMatcher:
    ...
    async def _analyze_word_batch_with_llm(
        ...
        prompt_lines.extend([
            ...
            "- Example: if phrase is 'neural organization', suggestion should be 'neural organization structure'",
            "",
            ...
            "",
            'EXAMPLE OUTPUT:',
            '- phrase: "neural organization"',
            '- suggestion: "neural organization structure"',  
            '- context: "Tortured phrase - incomplete expression. The phrase lacks specificity and sounds unnatural in academic writing. The suggestion adds clarity by specifying what type of organization is being discussed."',
            "",
            "Only include findings where you can provide BOTH a clear problem identification AND a clean improved phrase (no explanatory text)."
        ])
